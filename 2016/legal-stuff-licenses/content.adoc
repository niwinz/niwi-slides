...
> *It does not allow change to any license.*
...
I a simpler style _CLA_ with less frictionfor contributors.
...
Blog: https://www.niwi.nz

My twitter: https://twitter.com/niwinz

My github: https://github.com/niwinz and https://github.com/funcool
